...
#         name = img_path + '/' + file[i]
#         qualityscore = test_measure_BRISQUE(name)
#         score_list.append(qualityscore)
...
for i in range(len_file):
    name = path+ '/' + file[i]
    qualityscore = test_measure_BRISQUE(name)
    brisque_list.append(qualityscore)

print(brisque_list)

# # calculate quality score
# # sys.argv.append('/img_saple/test1.jpg')
# qualityscore = test_measure_BRISQUE(k)
